...
public class JarPackageUtil {
	 ...
	 *
	 */
	public static void addEntry(JarEntry entry, InputStream content, JarOutputStream fJarOutputStream) throws IOException {
	...
	public static MultiStatus writeArchive(ZipFile zipFile, boolean areDirectoryEntriesIncluded,
		...
		MultiStatus fStatus =  new MultiStatus(JavaManipulationPlugin.getPluginId(), IStatus.OK, ""); //$NON-NLS-1$
	 ...
	 * @since 1.14
	 */
	public static void addDirectories(String destPath, JarOutputStream fJarOutputStream, Set<String> fDirectories) throws IOException {
	 ...
	 * @since 1.14
	 */
	public static void addDirectories(IPath destinationPath, JarOutputStream fJarOutputStream, Set<String> fDirectories) throws IOException {
	 ...
	 * @since 1.14
	 */
	protected final static void addWarning(String message, Throwable error, MultiStatus fStatus) {
		fStatus.add(new Status(IStatus.WARNING, JavaManipulationPlugin.getPluginId(), IJavaStatusConstants.INTERNAL_ERROR, message, error));
	}
