...
import { IClassPaths } from "../exportJarSteps/IStepMetadata";
...
export namespace Jdtls {
    ...
    export function exportJar(mainMethod: string, classpaths: IClassPaths[], destination: string): Thenable<IExportResult> {
